...
if __name__ == '__main__':
    ...
    parser.add_argument("--query_encoder_location", type=str, default=None, help='Pretrained Query Encoder Location')
    ...
    assert args.query_encoder_location, 'Please specify --query_encoder_location checkpoint to init model weights'
